...
namespace torch_webgpu
{
    namespace ops
    {
        ...
        //             // still assuming 2D tensors
        //             auto rows_output = self.sizes()[0];
        //             auto cols_output = other.sizes()[1];
        //             const uint32_t workgroup_size_x = 8;
        //             const uint32_t workgroup_size_y = 8;
        //             uint32_t num_workgroups_x = ceil(workgroup_size_x / rows_output);
        //             uint32_t num_workgroups_y = ceil(workgroup_size_y / cols_output);

        //             pass_encoder.DispatchWorkgroups(num_workgroups_x, num_workgroups_y);
        //             pass_encoder.End();
