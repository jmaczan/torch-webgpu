...
namespace torch_webgpu
{
    namespace ops
    {
        ...
        void mm_kernel_webgpu(const at::Tensor &self, const at::Tensor &mat2, at::Tensor &out)
        {
            ...
            std::vector<wgpu::Buffer> buffers = {self_buffer, mat2_buffer, out_buffer, params_buffer};
            std::vector<uint64_t> sizes = {self_buffer.GetSize(), mat2_buffer.GetSize(), out_buffer.GetSize(), sizeof(Params)};
