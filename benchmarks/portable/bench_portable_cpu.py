#!/usr/bin/env python
"""
Portable CPU benchmark for Qwen2.5-0.5B-Instruct.

Works on any platform with Python and pip-installable packages.
No custom builds required.

Usage:
    pip install torch transformers
    python bench_portable_cpu.py --output results_cpu.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Portable CPU benchmark for Qwen2.5-0.5B")
    parser.add_argument("--output", type=str, default="results_cpu_portable.json", help="Output JSON file")
    ...
    if verbose:
        print("=" * 60)
        print("Qwen2.5-0.5B-Instruct CPU Benchmark (Portable)")
        print("=" * 60)
        print()
